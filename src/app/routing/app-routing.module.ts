...
import {UserImagesResolver} from "../resolvers/user-images-resolver/user-images.resolver";
...
const routes: Routes = [
  ...
  {
    path:'drive', component:UserDriveComponent, data:{animation:'drivePage'}, canActivate:[AuthGuard], resolve:{data: UserImagesResolver}
  }
